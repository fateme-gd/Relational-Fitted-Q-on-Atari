...
from environments.env_src.getout.getout.getout import Getout
...
class NudgeEnv(NudgeBaseEnv):
    ...
    def __init__(self, mode: str, plusplus=False, noise=False):
        ...
        self.noise = noise
        # register(id="getout",  
        #          entry_point="environments.env_src.getout.getout.getout:Getout")

        self.env = Getout()   #fateme fix this.  

        # self.env = gymnasium.make("getout")  # FIXME     #we must have an env that is somehow related to gymnasium
        # self.env = gym3.make("getout")  # FIXME

    def reset(self):
        state = self.env.reset()     #This returns null, why?
    ...
    def all_actions(self):
        return ["jump", "left_go_get_key","right_go_get_key","left_go_to_door","right_go_to_door"] #TO Do make this automated based on lang classes and functions
